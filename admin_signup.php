		...
		<div class="col-md-12 d-flex">
			...
			<?php } ?>	
				...
				<div class="left col-md-9 mt-5">
					<form action="confirm_admin_signup.php" name ="myForm" onsubmit="return validateForm()" method="post" class="mt-5" style="height:350px;width:500px;margin-left: 350px;" >
				<h1 class="text-center text-uppercase text-danger">Admin Sign up form</h1>
				...
				<a href="admin.php" class="btn btn-danger mt-4"style="border:1px  solid white; width:400px;  border-radius: 10px 10px 10px 10px; margin-left: 55px">Back</a>
