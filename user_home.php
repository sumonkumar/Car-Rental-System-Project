			...
			<div class="row bg-primary mx-auto">
				<div class="col-md-12">
					<marquee width="100%" direction="right" height="50px">
						<h3 class="text-white mt-2">Welcome To s Car Rentals. View Cars to Rent<h3>
					</marquee>
				</div>
			</div>
		<div class="row mx-auto">
			<div class="col-md-12 bg-dark">
				<nav class="navbar navbar-expand-lg sticky-top navbar-light">
					...
					<a href="user_car_view.php"><li class="nav-item mr-3"><span class="btn btn-warning text-white" style="font-size:15px">View Car</span></li></a>

					</a>
					<!-- <a href="user_profile.php"><li class="nav-item mr-3"><span class="btn btn-success text-white" style="font-size:15px">My Profile</span></li>
					</a> -->
		...
		<div class="row">
			<div class="col-md-3">
				<div class="card mt-4 p-2">
					...
					<a href="user_car_view.php" class="btn btn-info"> Rent </a>
				</div>
			</div>	
	...
	<!--last section-->
		<div class="row bg-dark mt-5">
			...
			<div class="col-md-3 mt-5 mb-4">
				...
				<a href="user_home.php" class="text-primary" style="font-size: 14px;">Top</a><br><br>
				<a href="#service" class="text-primary" style="font-size: 14px;">Service</a><br><br>
			</div>
