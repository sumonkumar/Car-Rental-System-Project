	...
	<div class="row bg-dark mx-auto" style="height: 700px;">
			...
			<div class="col-md-12 d-flex">
				...
				<div class="left col-md-9 mt-5">
					<form action="confirm_admin_login.php" method="post" class="mt-5" style="height:300px;width:500px;margin-left: 350px;">
				<h1 class="text-center text-uppercase text-success">Admin Login form</h1>
